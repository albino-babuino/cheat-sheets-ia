...
4. **[04.07-pandas-tipos-y-conversion.ipynb](04-pandas/04.07-pandas-tipos-y-conversion.ipynb)** - Tipos y conversión
   - `dtypes`, nulos (`None`, `NaN`, `pd.NA`, `NaT`), `astype`, `to_numeric` / `to_datetime`, `category`, nullable

5. **[04.04-pandas-io-analysis.ipynb](04-pandas/04.04-pandas-io-analysis.ipynb)** - I/O y análisis
   - Lectura de archivos (CSV, Excel, JSON, Parquet, HTML)
   - Escritura de archivos
   - Análisis descriptivo
   - Manejo de valores faltantes

6. **[04.05-pandas-visualization.ipynb](04-pandas/04.05-pandas-visualization.ipynb)** - Visualización de datos
...
7. **[04.06-numpy-pandas-pytorch-interop.ipynb](04-pandas/04.06-numpy-pandas-pytorch-interop.ipynb)** - Interoperabilidad Pandas ↔ PyTorch
...
│   ├── 04.07-pandas-tipos-y-conversion.ipynb
│   ├── 04.04-pandas-io-analysis.ipynb
│   ├── 04.05-pandas-visualization.ipynb
│   └── 04.06-numpy-pandas-pytorch-interop.ipynb
...
4. Continúa con **04 - Pandas** (04.01-04.07)
